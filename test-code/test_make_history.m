...
point_process = find_points(phase, points_per_bin);
...
find(point_process(1, :) == 1)
find(point_process(2, :) == 1)

bins_per_window = 1;
n_windows = 2;

history = make_history(point_process, bins_per_window, n_windows);
